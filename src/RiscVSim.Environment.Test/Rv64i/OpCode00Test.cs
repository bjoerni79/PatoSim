...
namespace RiscVSim.Environment.Test.Rv64i
{
    public class OpCode00Test
    {
        ...
        public void LhTest1WithoutRsTest1()
        {
            ...
            Assert.AreEqual(x10, new byte[] { 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
            Assert.AreEqual(x11, new byte[] { 0x03, 0x84, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF });
        ...
        public void LbTest1()
        {
            ...
            Assert.AreEqual(x10, new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
            Assert.AreEqual(x11, new byte[] { 0x83, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF });
        ...
        {
            core.Load(400, new byte[] { 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00 });
            core.Load(600, new byte[] { 0x05, 0x06, 0x07, 0x88, 0x00, 0x00, 0x00, 0x00 });
            ...
            Assert.AreEqual(x10, new byte[] { 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00 });
            Assert.AreEqual(x11, new byte[] { 0x05, 0x06, 0x07, 0x88, 0x00, 0x00, 0x00, 0x00 });
