...
namespace RiscVSim.Environment.Test.Rv64i
{
    ...
    public class Opcode04Test
    {
        ...
        public void AddITest2()
        {
            ...
            {
                var value = core.Register.ReadUnsignedLong(registerIndex);
        ...
        public void AndITest1()
        {
            ...
            Assert.AreEqual(x1Block, new byte[] { 0x05, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
            Assert.AreEqual(x2Block, new byte[] { 0x04, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
        }
        ...
        public void OrITest1()
        {
            ...
            Assert.AreEqual(x1Block, new byte[] { 0x05, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
            Assert.AreEqual(x2Block, new byte[] { 0x1F, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
        }
        ...
        public void XorITest1()
        {
            ...
            Assert.AreEqual(x1Block, new byte[] { 0x3C, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
            Assert.AreEqual(x2Block, new byte[] { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
        }
        ...
        public void XorIBitwiseComplementTest1()
        {
            ...
            Assert.AreEqual(x1Block, new byte[] { 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
