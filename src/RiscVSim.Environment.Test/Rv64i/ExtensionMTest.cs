...
namespace RiscVSim.Environment.Test.Rv64i
{
    public class ExtensionMTest
    {
        ...
        public void MulAndMulhTest3()
        {
            ...
            Assert.AreEqual(x12, new byte[] { 0x00, 0x00, 0x00, 0x01, 0xF0, 0x00, 0x00, 0x00 });
            Assert.AreEqual(x13, new byte[] { 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
        }
        ...
        public void MulwTest1()
        {
            ...
            program.AddRange(InstructionTypeFactory.Addi(10, 0, 2));
            program.AddRange(InstructionTypeFactory.Addi(11, 0, 10));
            program.AddRange(InstructionTypeFactory.MultiplyOP32(12, 10, 11, 0)); // MUL  : x12 = 2*10 = 20
        ...
        public void DivTest2()
        {
            ...
            Assert.AreEqual(x10, new byte[] { 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
            Assert.AreEqual(x11, new byte[] { 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
            Assert.AreEqual(x12, new byte[] { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
        ...
        public void DivwTest1()
        {
            program.AddRange(InstructionTypeFactory.Addi(10, 0, 3));
            program.AddRange(InstructionTypeFactory.Addi(11, 0, 2));
            program.AddRange(InstructionTypeFactory.DivideOP32(12, 10, 11, 4));
        ...
        public void RemwTest1()
        {
            ...
            program.AddRange(InstructionTypeFactory.Addi(11, 0, 2));
            program.AddRange(InstructionTypeFactory.DivideOP32(12, 10, 11, 6));
            ...
            Assert.AreEqual(x10, new byte[] { 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
            Assert.AreEqual(x11, new byte[] { 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
            Assert.AreEqual(x12, new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
        }

        [Test]
        public void RemwTest2()
        {
            program.AddRange(InstructionTypeFactory.Addi(10, 0, 3));
            program.AddRange(InstructionTypeFactory.Addi(11, 0, 2));
            program.AddRange(InstructionTypeFactory.DivideOP32(12, 10, 11, 6));
